function [u_hat,yp,rat1_1,t_old,gamma,y,t,yp1]=smoothing_second_derivative(rat1_1,new_time,ds,a,b)
% Thanks to this function, it's possible to compute the smoothing of the signal, its second time-derivative
...
u_hat=interp1(t,u_hat,t_old,'spline');
yp=interp1(t,yp1,t_old,'spline');
